      ...
      <div className="flex flex-col w-64 bg-slate-900 text-white">
        ...
        <div className="flex flex-col flex-grow p-4 space-y-2">
          ...
          <div className="mt-auto">
            <button
              onClick={onExitAdmin}
              className="flex items-center w-full px-4 py-3 text-left transition-colors duration-200 rounded-md text-gray-400 hover:bg-slate-700 hover:text-white"
            >
