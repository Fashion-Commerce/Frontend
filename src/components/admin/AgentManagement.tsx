...
const AgentCard: React.FC<{ agent: AgentType, description: string }> = ({ agent, description }) => (
    <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="flex justify-between items-center">
            ...
            <button className="text-sm font-semibold text-blue-600 hover:text-blue-800">Cấu hình</button>
        </div>
    </div>
);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             <div className="mt-8 bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                    Đây là nơi để thiết lập các thông số chung cho hệ thống multi-agent, chẳng hạn như lời chào mặc định, agent xử lý khi không xác định được ý định, v.v.
                </p>
            </div>
        </div>
    );
