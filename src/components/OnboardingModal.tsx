...
const CategoryCard: React.FC<{ name: string; icon: string; onSelect: () => void; isSelected: boolean }> = ({ name, icon, onSelect, isSelected }) => {
    return (
        <button 
            onClick={onSelect}
        ...
        >
            ...
            <span className="font-semibold text-lg text-gray-800 dark:text-gray-200">{name}</span>
        </button>
    );
};
    ...
    <div className="fixed inset-0 bg-gray-100 dark:bg-slate-900 z-50 flex items-center justify-center p-4 animate-fade-in">
        <div className="w-full max-w-2xl text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
                Hãy cho chúng tôi biết phong cách của bạn. Chọn những danh mục bạn yêu thích.
            </p>
