...
// ========== API CONFIGURATION ==========
export const API_BASE_URL = (import.meta as any).env?.VITE_API_BASE_URL || 'http://localhost:8000/v1';
...
export const AGENT_KEYWORDS = {
  SEARCH: ['tìm', 'search', 'có', 'giá', 'bao nhiêu', 'xem', 'hiển thị', 'show'],
  ADVISOR: ['phối', 'combo', 'gợi ý', 'phù hợp', 'tư vấn', 'đẹp', 'outfit', 'style'],
  ORDER: ['mua', 'đặt', 'order', 'giỏ hàng', 'cart', 'thanh toán', 'checkout', 'xác nhận'],
};
...
export const TOUR_STEPS = [
  {
    ...
    title: 'Chat với AI',
    description: 'Trò chuyện với AI để tìm sản phẩm, được tư vấn, hoặc đặt hàng',
  },
  {
